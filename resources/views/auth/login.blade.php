...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        body {
            background-image: url('/assets/images/smk_palebon_BG.webp');
    ...
    <div class="relative w-full max-w-md">
        <div
            ...
            <div class="p-8 text-center">
                <div
                    class="w-16 h-16 bg-linear-to-r from-indigo-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
