        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                <div class="flex flex-col justify-between">
                    <div>
                        <h1
                            class="text-3xl font-bold  dark:text-white mb-3 bg-gradient-to-r from-gray-600 to-gray-600 text-transparent bg-clip-text hover:from-blue-500 hover:to-purple-500 transition-colors duration-300">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="ml-2">
                            ...
                            <a href="{{ route('tag.show', $tag->slug) }}"
                                class="inline-block dark:bg-gray-700 bg-gradient-to-r from-blue-300 to-purple-400  dark:text-gray-200 rounded-full px-3 py-1 text-sm font-semibold mr-2 mb-2 hover:from-blue-600 hover:to-purple-600 dark:hover:bg-gray-600 transition">
                                {{ $tag->name }}
                            </a>
                            {{-- @endforeach --}}
                        </span>
