...
@section('content')
{{-- <section id="blog" class="container py-12 mx-auto px-4 bg-gray-50 mt-[20vh] max-w-7xl"> --}}
	<div class="mt-[20vh] container mx-auto px-4 max-w-7xl">
			...
			<div class="gallery-item rounded-lg overflow-hidden shadow-lg bg-white cat-{{ $gallery->kategori_id }} flex flex-col cursor-pointer gallery-trigger"
				...
				<div class="p-4 flex-1 flex flex-col justify-between">
					<div>
						...
						<p class="mt-2 text-gray-700 text-center md:text-left">{{ Str::limit($gallery->deskripsi, 60) }}
						</p>
						@endif
					</div>
				</div>
